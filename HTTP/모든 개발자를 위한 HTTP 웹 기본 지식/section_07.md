...
8. 쿠키
    ...
    * Stateless
    ...
    - ex) set-cookie: sessionId=abcde1234l expires=Sat, 26-Dec-2022 00:00:00 GMT; path=/; domain=.google.com; Secure
    ...
    - 생명주기
        - Expires
            - ex) Set-Cookie: expires=Sat, 26-Dec-2022 00:00:00 GMT
            - 만료일이 되면 쿠키 삭제
        - max-age
